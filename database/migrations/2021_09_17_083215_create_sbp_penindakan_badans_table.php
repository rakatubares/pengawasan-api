...
class CreateSbpPenindakanBadansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sbp_penindakan_badans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sbp_penindakan_badans');
    }
}
