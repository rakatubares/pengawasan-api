...
use App\Http\Controllers\Intelijen\DokLptiNController;
...
use App\Http\Controllers\Penindakan\DokLpNController;
use App\Http\Controllers\Penindakan\DokLptController;
...
use App\Http\Controllers\Penindakan\DokSbpNController;
...
Route::group(['prefix' => 'doc', 'middleware' => ['auth.user']], function() {
    Route::docResources([
        ...
        'lptin' => DokLptiNController::class,
