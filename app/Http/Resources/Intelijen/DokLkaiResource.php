...
class DokLkaiResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $array['lpti_id'] = $lpti != null ? $lpti->id : null;
        $array['nomor_lpti'] = $lpti != null ? $lpti->no_dok_lengkap : null;
        $array['tanggal_lpti'] = $lpti != null ? $lpti->tanggal_dokumen->format('d-m-Y') : null;
