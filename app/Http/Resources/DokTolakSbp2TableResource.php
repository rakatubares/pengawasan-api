...
class DokTolakSbp2TableResource extends JsonResource
{
    ...
    {
		$sbp_type = $this->tolak1->sbp_relation->object1_type;
        ...
        $array = [
			...
			'nomor_sbp' => $this->tolak1[$sbp_type]->no_dok_lengkap,
			'tanggal_sbp' => $this->tolak1[$sbp_type]->penindakan->tanggal_penindakan->format('d-m-Y'),
			'pemilik' => $this->tolak1[$sbp_type]->penindakan->saksi->nama,
